...
$packageName= 'unifi-controller' # arbitrary name for the package, used in messages
$toolsDir   = "$(Split-Path -parent $MyInvocation.MyCommand.Definition)"
$url        = 'https://dl.ubnt.com/unifi/5.3.8/UniFi-installer.exe' # download url, HTTPS preferred
